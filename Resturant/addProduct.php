            ...
            <div class="recent-updates card" style="padding-bottom: 21px;">
              ...
              <div class="card-body padding">
                <form action="" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="p_name" class="font-weight-bold grand">Dish-Name :</label>
                      <div class="form-group">
                        <input type="text" id="p_name" name="product_name" class="form-control" placeholder="Enter Product name..." required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <label for="product_category" class="font-weight-bold grand">Dish-Category :</label>
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="file" class="font-weight-bold grand">Dish-Image</label>
                      <div class="form-group">
                        <input type="file" id="file" name="file" class="form-control" placeholder="Choose Product Image..." required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <label for="price" class="font-weight-bold grand">Dish-Price</label>
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-6" >
                      <label for="size" class="font-weight-bold grand">Origin of Dish (Size,Thalis,Jambo,Mini,fries,Pasta,Maggi Berger,Pizza)</label>
                      <div class="form-group">
                    ...
                    <div class="col-sm-6" >
                      <label for="desc" class="font-weight-bold grand">Dish-Description:</label>
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group text-right" style="position: relative;top: 10px;">
                        <button type="submit" name="add_product" class="btn btn-primary px-5 font-weight-bold  BtnSet">
                        Add Dish</button>
                      </div>
                    </div>
