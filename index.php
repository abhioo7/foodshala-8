   ...
   <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
		     <div class="carousel-item active">
              <img class="d-block img-fluid slider" src="img/p11.jpg"  alt="First slide">
              <div class="carousel-caption">
                <h3 class="h3-responsive">Chilli Potato</h3>
                <p><span class="badge-pill badge-primary opacity-25">Veg/Non-Veg</span></p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid slider" src="img/p8.jpg"  alt="First slide">
              <div class="carousel-caption">
                <h3 class="h3-responsive">Kathi Roll</h3>
                <p><span class="badge-pill badge-primary opacity-25">Veg And non veg Roll</span></p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid slider" src="img/p6.jpg"  alt="Second slide">
              <div class="carousel-caption">
                <h3 class="h3-responsive">Noodels </h3>
                <p><span class="badge-pill badge-primary"> Veg</span></p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid slider" src="img/p3.jpg"  alt="Third slide">
              <div class="carousel-caption">
                <h3 class="h3-responsive">Indian Platter</h3>
                <p><span class="badge-pill badge-primary">Veg/Non-Veg</span></p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid slider" src="img/p10.jpg"  alt="Fouth slide">
              <div class="carousel-caption">
              <h3 class="h3-responsive">Burger/French-Fries</h3>
                <p><span class="badge-pill badge-primary">Veg/Non-Veg</span></p>
            </div>
            </div>
            <div class="carousel-item">
              ...
              <div class="carousel-caption">
              <h3 class="h3-responsive">Our Special</h3>
                <p><span class="badge-pill badge-primary">Veg</span></p>
            </div>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid slider" src="img/p7.jpg"  alt="Sixth slide">
              <div class="carousel-caption">
              <h3 class="h3-responsive">Mood Refreshing Drinks</h3>
                <p><span class="badge-pill badge-primary">With Ice</span></p>
            </div>
            </div>
          </div>
       ...
       <h3 style="color:black; margin-bottom:30px"> Today's <b style="color:red">SPECIAL</b> is three mouth-watering dishes</h2>
       <div class="row ">
        <?php
